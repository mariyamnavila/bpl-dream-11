...
const Player = ({ player, stopDuplicate, coins }) => {
    // console.log(coins);
    ...
    return (
        <div className="p-6 space-y-4 border border-gray-300 rounded-2xl">
            ...
            <div className="flex justify-between items-center">
                ...
                <button onClick={() => { stopDuplicate(player, coins, bidding_price) }} className="py-2 px-4 text-[14px] border border-gray-300 rounded-lg hover:bg-yellow-300">Choose Player</button>
            </div>
        </div>
    );
};
